...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>New follow Dogsquare</title>
...
<h4><img src="http://www.<?php echo $_SERVER['HTTP_HOST']; ?>/email/photo.jpg" width="180" height="180" style="border-radius: 90px; -moz-border-radius: 90px; /></h4>
                                        ...
                                        <tr>
                                            <td align="center" valign="top" style="padding-top:20px;"><span class="preheaderContent"><?php echo $followers; ?> followers | <?php echo $following; ?> following | <?php echo $dogs; ?> dogs</span></td>
