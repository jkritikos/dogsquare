...
define("NEARBY_DISTANCE", 7);
//Default distance filter for nearby checkins (map)
define("NEARBY_DISTANCE_CHECKINS", 7);
...
define("MAP_FILTER_AGILITY_CENTER", 11);
define("MAP_FILTER_DOG_TRAINER", 12);
...
define("ERROR_USER_PASSWORD", -21);
define("ERROR_PLACE_DELETION", -22);
